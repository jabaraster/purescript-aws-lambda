...
``` purescript
deleteFunction :: forall eff. DeleteFunctionRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
removeEventSource :: forall eff. RemoveEventSourceRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
